...
#import "AWUFeatureCardsView.h"
#import "AWUFeatureCardsCell.h"

@interface AWUFeatureCardsView() <UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation AWUFeatureCardsView
...
- (UICollectionView *)cardsCollectionV {
    if (!_cardsCollectionV) {
        ...
        layout.itemSize = CGSizeMake(86, 86);
        ...
        [_cardsCollectionV registerClass:AWUFeatureCardsCell.class forCellWithReuseIdentifier:@"AWUFeatureCardsCell"];
    }
...
#pragma mark - 填充数据
- (void)setDataArray:(NSArray<AWUFeatureModel *> *)dataArray {
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    AWUFeatureCardsCell *cell = (AWUFeatureCardsCell *)[collectionView dequeueReusableCellWithReuseIdentifier:@"AWUFeatureCardsCell" forIndexPath:indexPath];
